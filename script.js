new Vue({
  ...
  data: {
    panes: [
      ...
      { color: '#FFFFFF', content: '<h1 id="health-score-pane" class="lefties">Discover your health score. <br>Improve your daily routine.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/Health%20Score%20-%20iPhone%2014%20%26%2015%20Pro.png" class="centered-image" alt="Health Score">' },
      { color: '#FFFFFF', content: '<h1 id="planning-pane" class="lefties">We take care of the planning. <br>You focus on execution.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/we_take_care_of_planning.png" id="planning_img" class="centered-image" alt="Planning">' },
