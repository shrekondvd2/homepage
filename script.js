new Vue({
  ...
  data: {
    panes: [
      ...
      { color: '#FFFFFF', content: '<h1 id="planning_pane" class="lefties">Stay in control of time. <br>We give you back +56hrs/mo.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/relaxing_updated.png" class="planning_img" alt="Planning">' },
