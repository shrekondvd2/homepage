new Vue({
  ...
  data: {
    panes: [
      ...
      { color: '#FFFFFF', content: '<h1 id="planning_pane" class="lefties">No thinking required. <br>Smart reminder algorithm.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/nexa%20push%20notification.png" class="planning_img" alt="Planning">' },
