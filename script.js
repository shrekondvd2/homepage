new Vue({
  ...
  data: {
    panes: [
      ...
      { color: '#FFFFFF', content: '<h1 id="be-bold-text"><strong>Be bold.</strong> <br>Be precise.<br>Be proactive.</h1><button class="try-button" @click="redirectToLink">Try it free</button>' }
    ],
    currentPane: 0,
    isScrolling: false,
    scrollTimeout: null,
