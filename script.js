new Vue({
  ...
  data: {
    panes: [
      ...
      { color: '#FFFFFF', content: '<h1 id="planning_pane" class="lefties">No more  tracking. <br>We keep you informed.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/nexa%20push%20notification.png" class="planning_img" alt="Planning">' },
      { color: '#FFFFFF', content: '<h1 id="planning_pane" class="lefties">Just show up.<br>We take care of the rest.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/images/working%20out%20female%20home.png" class="planning_img" alt="Planning">' },
      ...
      { color: '#FFFFFF', content: '<h1 id="planning_pane" class="lefties">This is not a "workout" app. <br>Nexa is a longevity companion. <br><br>We automate your daily routine optimizing for 5 biomarkers.' },
