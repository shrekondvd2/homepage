new Vue({
  ...
  data: {
    panes: [
      ...
      { color: '#FFFFFF', content: '<h1 id="planning_pane" class="lefties">We take care of the planning. <br>You focus on execution.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/we_take_care_of_planning.png" class="centered-image planning_img" alt="Planning">' },
