  ...
  data: {
    panes: [
      ...
      // { color: '#F6F1E5', content: '<img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/images/nexa%20logo%20icon%20no%20background.png" alt="Nexa Logo" class="pane-logo"> <h1 id="header-text" class="font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl">Optimize how you<br>move, eat and sleep.<br><br>A guide for<br><span id="dynamic-text"></span></h1>'},
       ...
       { color: '#F6F1E5', content: '<img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/images/nexa%20logo%20icon%20no%20background.png" alt="Nexa Logo" class="pane-logo"> <h1 id="header-text">Systemize your routine.<br>Nexa optimizes how you<br>move, eat and sleep.'},
      ...
      { color: '#FFFFFF', content: '<h1 id="health-score-pane" class="lefties">No more guessing. <br>We compute your health score.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/health%20score%20side%20by%20side.png" class="health-score-image" alt="Health Score" onclick="window.location.href=\'https://testflight.apple.com/join/i7Ie7qGd\'">' },
      { color: '#FFFFFF', content: '<h1 id="planning_pane" class="lefties">No more research. <br>We plan your fitness and meals.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/we_take_care_of_planning.png" class="planning_img" alt="Planning">' },
      { color: '#FFFFFF', content: '<h1 id="planning_pane" class="lefties">No more manual tracking. <br>We use AI powered reminders.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/nexa%20push%20notification.png" class="planning_img" alt="Planning">' },
      { color: '#FFFFFF', content: '<h1 id="planning_pane" class="lefties">Reclaim your time. <br>Nexa saves you 45 hrs a month.</h1><img src="https://i2.wp.com/cdn.dribbble.com/users/862175/screenshots/6414127/dribbble.gif" class="planning_img" alt="Planning">' },
      { color: '#FFFFFF', content: '<h1 id="planning_pane" class="lefties">You just need to show up.<br>We take care of the rest.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/images/working%20out%20female%20home.png" class="planning_img" alt="Planning">' },
