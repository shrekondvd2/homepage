new Vue({
  ...
  data: {
    panes: [
      ...
      { color: '#FFFFFF', content: '<h1 id="planning_pane" class="lefties">No more planning. <br>We systemize workouts and meals.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/we_take_care_of_planning.png" class="planning_img" alt="Planning">' },
      ...
      { color: '#FFFFFF', content: '<h1 id="planning_pane" class="lefties">Get back +56hrs/month. <br>Systemize: Eat, Move, Sleep.</h1><img src="https://raw.githubusercontent.com/shrekondvd2/homepage/main/relaxing_updated.png" class="planning_img" alt="Planning">' },
